      ...
      <div className="pt-6">
        ...
        <div className=" lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
          <div className="lg:col-span-2 ">
            <h1 className="text-2xl lg:text-xl font-semibold text-gray-900">UniversalOutfit</h1>
            <h1 className='text-lg lg:text-xl text-gray-900 opacity-60 pt-1'>Hello bitches</h1>
          </div>
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <div className="mt-6">
             ...
             <p className='ml-3 trext-sm font-medium text-indigo-600 hover:text-indigo-400'>3870 reviews</p>
             </div>
